...
digraph {
  ...
  node_5 [label="bevy_mod_scripting_core::asset::remove_entity_associated_contexts<bevy_mod_scripting_lua::LuaScriptingPlugin>"];
  node_6 [label="on_test_post_update"];
  ...
  node_6 -> node_9 [color=blue, label="runs before", arrowhead=normal];
  node_6 -> node_10 [color=blue, label="runs before", arrowhead=normal];
